...
def customers(request,id=-1):
    if request.method == 'GET':#method get all and single
        ...
        if int(id) > -1: #get single product
            ...
            return Response(CustomerSerializer().get_Customers(CustomerObj)) #return array as json response
...
def countries(request,id=-1):
    if request.method == 'GET':#method get all and single
        ...
        if int(id) > -1: #get single product
            ...
            # return Response(serializer.data)
            return Response(CountriesSerializer().get_Countries(CountriesObj)) #return array as json response
...
def Airline_Companies(request,id=-1):
    if request.method == 'GET':#method get all and single
        ...
        if int(id) > -1: #get single product
            ...
            # return Response(serializer.data)
            return Response(Airline_CompaniesSerializer().get_Airline_Companies(AirlineCompaniesOBJ)) #return array as json response
...
def flights(request,id=-1):
    if request.method == 'GET':#method get all and single
        ...
        if int(id) > -1: #get single product
            ...
            # return Response(serializer.data)
            return Response(FlightsSerializer().get_Flights(FlightsObj)) #return array as json response
...
def User_Roles(request,id=-1):
    if request.method == 'GET':#method get all and single
        ...
        if int(id) > -1: #get single product
            ...
            # return Response(serializer.data)
            return Response(User_RolesSerializer().get_User_Roles(User_RolesObj)) #return array as json response
